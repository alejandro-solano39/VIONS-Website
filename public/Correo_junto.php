...
try {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'], $_POST['name'], $_POST['message'], $_POST['formCategory'])) {
        $recipientEmail = $_POST['email'];
        $recipientName = $_POST['name'];
        $message = nl2br(htmlspecialchars($_POST['message'], ENT_QUOTES, 'UTF-8'));
        $category = htmlspecialchars($_POST['formCategory'], ENT_QUOTES, 'UTF-8');
