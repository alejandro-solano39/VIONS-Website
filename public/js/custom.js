...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!dynamicText) {
        console.warn('Elemento .dynamic-text no encontrado');
        return; // Termina la ejecución si el elemento no está presente
    }

    const textArray = ['Digital Artist'];
    let currentText = 0;
    let charIndex = 0;
    let isDeleting = false;

    function typeAnimation() {
        const currentWord = textArray[currentText];
