...
jQuery(document).ready(function() {
	...
	$(document).ready(function() {
		$('.mfp-gallery-with-owl').magnificPopup({
			delegate: 'a', // Selector para abrir el popup en los elementos 'a'
			type: 'image',
			gallery: {
				enabled: true
			},
			callbacks: {
				elementParse: function(item) {
					// Cambiamos el tipo de contenido basado en si es video o imagen
...
/* Document .ready END */
// Seleccionar todos los videos en el slider
const videos = document.querySelectorAll('.portfolio-carousel video');
